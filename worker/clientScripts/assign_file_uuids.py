...
from worker.utils.archivematicaFunctions import chunk_iterable
from worker.utils.archivematicaFunctions import find_mets_file
...
logger = get_script_logger("archivematica.worker.assignFileUUID")
