...
from worker.clientScripts import identify_file_format
...
@pytest.mark.django_db
@mock.patch("worker.clientScripts.identify_file_format.executeOrRun")
...
@pytest.mark.django_db
@mock.patch(
    "worker.clientScripts.identify_file_format.executeOrRun",
