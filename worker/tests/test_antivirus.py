...
from worker.clientScripts.antivirus import create_scanner
from worker.clientScripts.antivirus import scan_file
...
@mock.patch("worker.clientScripts.antivirus.file_already_scanned")
@mock.patch("worker.main.models.File.objects.get")
@mock.patch("worker.clientScripts.antivirus.create_scanner")
