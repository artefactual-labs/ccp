...
from worker.clientScripts import validate_file
...
@mock.patch(
    "worker.clientScripts.validate_file.executeOrRun",
    return_value=(
        0,
        json.dumps(
            {
...
@mock.patch("worker.clientScripts.validate_file.executeOrRun")
