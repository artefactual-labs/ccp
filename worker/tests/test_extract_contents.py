...
from worker.clientScripts import extract_contents
...
@pytest.mark.django_db
@mock.patch(
    "worker.clientScripts.extract_contents.executeOrRun",
...
@pytest.mark.django_db
@mock.patch("worker.clientScripts.extract_contents.executeOrRun")
