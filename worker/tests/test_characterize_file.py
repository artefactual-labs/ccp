...
from worker.clientScripts import characterize_file
...
@mock.patch("worker.clientScripts.characterize_file.executeOrRun")
...
@pytest.mark.django_db
@mock.patch("worker.clientScripts.characterize_file.insertIntoFPCommandOutput")
@mock.patch("worker.clientScripts.characterize_file.etree")
@mock.patch("worker.clientScripts.characterize_file.executeOrRun")
