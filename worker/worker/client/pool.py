...
WorkerPool is the core of the worker, a pool of system processes that are
...
from worker.client import loader
from worker.client import metrics
from worker.client.gearman import MCPGearmanWorker
...
class WorkerPool:
    ...
    def _start_worker(self, index: int) -> multiprocessing.Process:
        ...
        worker = multiprocessing.Process(
            name=f"ArchivematicaWorker-{index}",
