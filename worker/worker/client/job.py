"""
A Job is the worker's representation of a unit of work to be performed,
corresponding to a Task on the server side. Jobs are run in batches by
clientScript modules and populated with an exit code, standard out and standard
error information.
"""
...
from worker.main.models import Task

logger = logging.getLogger("archivematica.worker.job")
