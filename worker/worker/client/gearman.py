...
from worker.client.loader import load_job_modules
from worker.client.utils import parse_command_line
from worker.client.utils import replace_task_arguments
from worker.client.worker import run_task
...
class MCPGearmanWorker(gearman.GearmanWorker):  # type: ignore
    ...
    def __init__(
        ...
        self.client_id = f"worker-{multiprocessing.current_process().pid}"
