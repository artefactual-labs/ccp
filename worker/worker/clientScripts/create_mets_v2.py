...
from worker.clientScripts import archivematicaCreateMETSMetadataXML
from worker.clientScripts import archivematicaCreateMETSReingest
from worker.clientScripts.archivematicaCreateMETSMetadataCSV import parseMetadata
from worker.clientScripts.archivematicaCreateMETSRights import archivematicaGetRights
from worker.clientScripts.archivematicaCreateMETSRightsDspaceMDRef import (
    archivematicaCreateMETSRightsDspaceMDRef,
)
from worker.clientScripts.archivematicaCreateMETSTrim import getTrimAmdSec
from worker.clientScripts.archivematicaCreateMETSTrim import getTrimDmdSec
from worker.clientScripts.archivematicaCreateMETSTrim import getTrimFileAmdSec
from worker.clientScripts.archivematicaCreateMETSTrim import getTrimFileDmdSec
from worker.clientScripts.change_names import change_name
from worker.clientScripts.create_mets_dataverse_v2 import create_dataverse_sip_dmdsec
from worker.clientScripts.create_mets_dataverse_v2 import (
...
from worker.utils.archivematicaFunctions import normalizeNonDcElementName
...
logger = get_script_logger("archivematica.worker.createMETS2")
...
def main(
    ...
    mets, xml_metadata_errors = archivematicaCreateMETSMetadataXML.process_xml_metadata(
        ...
        sipUUID,
        sipType,
        getattr(django_settings, "XML_VALIDATION", False),
    )
    ...
    if len(xml_metadata_errors):
        ...
        if getattr(django_settings, "XML_VALIDATION_FAIL_ON_ERROR", False):
            state.error_accumulator.error_count += 1
