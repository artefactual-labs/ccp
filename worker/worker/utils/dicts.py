...
class ReplacementDict(dict):
    ...
    def frommodel(type_="file", sip=None, file_=None, expand_path=True):
        ...
        worker. If the expand_path keyword argument is set to True,
        then true absolute paths will be returned instead. This is useful
        when creating ReplacementDicts within worker scripts.
        ...
        # Currently, the server does not use the Django ORM.
        # In order to make this code accessible to the server,
