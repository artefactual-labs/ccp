...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.updateTaskCompletionStmt, err = db.PrepareContext(ctx, updateTaskCompletion); err != nil {
		return nil, fmt.Errorf("error preparing query UpdateTaskCompletion: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.updateTaskCompletionStmt != nil {
		if cerr := q.updateTaskCompletionStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing updateTaskCompletionStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	updateTaskCompletionStmt                *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		updateTaskCompletionStmt:                q.updateTaskCompletionStmt,
